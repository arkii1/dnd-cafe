...
export default function GameRoom() {
    return <>
        <section className="relative h-[100vh] sm:h-[1200px]">
            ...
            <div className="absolute flex flex-col justify-start items-between py-4 insert-0 h-2/3 top-1/3 mx-10">
                <div className="flex flex-col justify-start items-start p-4 text-start gap-3 h-full bg-slate-100 text-sky-700 shadow outline-0">
