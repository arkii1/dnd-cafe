        ...
        <section className="relative h-[1200px]">
            <div className="absolute flex justify-between items-center insert-0 h-full w-full bg-transparent">
                <div className="h-3/4 w-2/3">
                    <div className="flex flex-col justify-center items-start ml-35 text-start w-full h-full border-stone-100 border-0 rounded-4xl">
                ...
                <div className="right-0 h-full bg-stone-900 w-1/3 flex items-center shadow-2xl">
